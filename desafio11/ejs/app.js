...
app.get('/',(req,res)=>{
    res.render("formulario",{titulo:"Formulario de ingreso"});
})
app.get("/productos/vista", async (req, res) => {
    try{
        ...
        res.render("vista.ejs",{productos: contenido, titulo:"Vista de productos"});
    }catch(e){
        res.render ("vista.ejs",{error: e.message, titulo:"Error", productos:[]});
    }
});
...
app.post('/productos/guardar',async (req,res)=>{
    ...
    try{
        ...
        res.json({"error":e.message, titulo:"Formulario de ingreso"});
    }
})
/*
